...
class CourseRepositoryTest {
    ...
    public void saveCourseWithTeacher() {
        Teacher teacher = Teacher.builder().firstName("Jordan").lastName("Dhabi").build();
    ...
    public void saveCourseWithStudentAndTeacher() {
        ...
        Teacher teacher = Teacher.builder().firstName("Bla").lastName("Ble").build();
        Student student = Student.builder().firstName("Cla").lastName("Cle").emailId("cli@gmail.com").build();
        Course course = Course.builder().title("TI").credit(12).teacher(teacher).build();
